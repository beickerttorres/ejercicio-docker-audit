...
| 8 | `Dockerfile` | 1 | Trivy (CI) | CVE-* | **Crítica** | Imagen base `python:3.8` en **End of Life** con múltiples CVEs críticos en la cadena de dependencias del sistema. | Migrar a `python:3.12-slim` y mantener actualizado. |
